...
Notice that W.
Henderson Waugh and William Pitt Waugh Jr. share the same `dadID` — William Pitt Waugh Sr. — reflecting the half-sibling relationship in the parsed data.
...
Qualifiers and escapes are stripped first:
