...
2. **GitHub Actions**:  
    - [Link](https://github.com/R-Computing-Lab/tidygedcom/actions/runs/31262078665)
...
There are no published references describing the methods in this package. However, as requested, we've added a relevant related paper of ours that is highly related to this package and sister package. The
